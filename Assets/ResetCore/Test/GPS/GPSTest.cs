...
public class GPSTest : MonoBehaviour
{
    ...
    IEnumerator StartGPS()
    {
        ...
        {
            Debug.logger.Log("Not enable GPS");
            yield break;
        }
        ...
        {
            Debug.logger.Log("Unable to determine device location");
            yield break;
        }
        else
        {
            // Access granted and location value could be retrieved
            Debug.logger.Log("Location: " + Input.location.lastData.latitude + " " + 
